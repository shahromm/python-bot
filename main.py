...
BOT_TOKEN = "6066549343:AAGoEVGQ9M1p595G_m3NN3pgJOn3ZmnS5_o"
PAYMENT_CHANNEL = "@umedteambot" #add payment channel here including the '@' sign
OWNER_ID = 5786756317 #write owner's user id here.. get it from @MissRose_Bot by /id
CHANNELS = ["@umedteambot"] #add channels to be checked here in the format - ["Channel 1", "Channel 2"] 
